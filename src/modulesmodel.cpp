...
{
    auto plugin = KPluginMetaData::findPluginById(QStringLiteral("kcms/"), name);
    auto module = KPluginFactory::instantiatePlugin<KQuickAddons::ConfigModule>(plugin, const_cast<ModulesModel *>(this));
